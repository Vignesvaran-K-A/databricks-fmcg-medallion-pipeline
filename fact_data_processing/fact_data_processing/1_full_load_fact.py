...
# MAGIC %run /Workspace/Users/vignesvaranananthi@gmail.com/consolidated_pipeline/setup/utilities
...
base_path = f's3://fmcg-child-company/{data_source}'
...
display(dbutils.fs.ls("s3://fmcg-child-company/orders/landing"))

# COMMAND ----------

files = dbutils.fs.ls("s3://fmcg-child-company/orders/processed")

for file_info in files:
    dbutils.fs.mv(
        file_info.path,
        f"s3://fmcg-child-company/orders/landing/{file_info.name}",
        True
    )
